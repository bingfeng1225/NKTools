...
public class SizeUtils {
    ...
    public static boolean isPxVal(TypedValue val) {
        int complexUnit = TypedValue.COMPLEX_UNIT_MASK & (val.data >> TypedValue.COMPLEX_UNIT_SHIFT);
        if (val != null && val.type == TypedValue.TYPE_DIMENSION && complexUnit == TypedValue.COMPLEX_UNIT_PX) {
            return true;
        }
        return false;
    }
